                ...
                <tbody>
                    <?php foreach ($query as $key => $value) { ?>
                        <tr>
                            ...
                            <td><button href='../index.php?akses=login_nis&nis=<?= $value["nis"]; ?>'
                                    class='btn btn-sm btn-primary btn-sm border-0' data-bs-toggle="modal"
                                    data-bs-target="#detail<?= $value['nis']; ?>"><i
                                        class="fa-solid fa-circle-info fa-beat"></i>&nbsp;Detail</button>
                            </td>
                        </tr>
                        <!-- Modal -->
                        <div class="modal fade" id="detail<?= $value['nis']; ?>" data-bs-backdrop="static"
                            data-bs-keyboard="false" tabindex="-1" aria-labelledby="detail<?= $value['nis']; ?>Label"
                            aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <h5><i class="fa-solid fa-circle-info"></i>&nbsp;Sudah terdaftar ke tempat Perakerin!
                                        </h5>

                                        <div class="input-group mb-3">
                                            <span class="input-group-text bg-dark text-light gradient">Nama </span>
                                            <input type="text" class="form-control" value="<?= $value["namasiswa"]; ?>"
                                                disabled>
                                        </div>
                                        <div class="input-group mb-3">
                                        ...
                                        <div class="mb-3">
                                            <a href="<?= $lokasi_dudi; ?>" class="btn btn-outline-primary btn-sm"
                                                target="_blank"><i
                                                    class="fa-solid fa-location-dot fa-bounce text-danger"></i>&nbsp;Lihat
                                                Lokasi di Maps</a>
                                        </div>
                                        <div class="input-group mb-3">
                                            <span class="input-group-text bg-dark text-light gradient">Pembimbing </span>
                                            <input type="text" class="form-control" value="<?= $value["pembimbing"]; ?>"
                                                disabled>
                                            <?php
                                            ...
                                            ?>
                                            <span class="input-group-text bg-success btn-success"><a href="<?= $link_wa; ?>"
                                                    class="text-light"><i class="fa-brands fa-whatsapp fa-beat"></i></a></span>
                                        </div>
                                        ...
                                        <a href="../print.php?akses=print&nis=<?= $value["nis"]; ?>&kode=<?= $hasil["kode"]; ?>"
                                            class="btn btn-info border-0"><i
                                                class="fa-solid fa-print fa-beat"></i>&nbsp;&nbsp;Cetak Surat Pernyataan</a>
                                        <button data-bs-dismiss="modal" aria-label="Close"
                                            class="btn btn-dark border-0 float-end"><i
                                                class="fa-solid fa-times"></i>&nbsp;Tutup</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <body>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            L:&nbsp;
                            <span
                                class="badge text-bg-info"><?= $data4_jml_L["jumlah_l"] ? $data4_jml_L["jumlah_l"] : " - Kosong"; ?></span>&nbsp;
                            P:&nbsp;
                            <span
                                class="badge text-bg-info"><?= $data4_jml_P["jumlah_p"] ? $data4_jml_P["jumlah_p"] : " - Kosong"; ?></span>&nbsp;
                        </td>
                    </tr>
                    <tr>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            dari&nbsp;
                            <span
                                class="badge text-bg-success"><?= $data6_jumlah_dudi_tersisa["jumlah_dudi_tersisa"]; ?></span>&nbsp;
                            DUDIKA
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            ...
                            L:&nbsp;
                            <span
                                class="badge text-bg-primary"><?= $data3["kuotacow"] ? $data3["kuotacow"] : " - Kosong"; ?></span>&nbsp;
                            P:&nbsp;
                            <span
                                class="badge text-bg-primary"><?= $data3["kuotacew"] ? $data3["kuotacew"] : " - Kosong"; ?></span><br>&nbsp;&nbsp;
                            <i class="fa-solid fa-arrow-right"></i>&nbsp;
                            L/P:&nbsp;
                            <span
