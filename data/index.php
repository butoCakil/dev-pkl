                ...
                << Kembali</button><br>
                    ...
                    for ($i = 0; $i < 3; $i++) {
                        ...
                        <form action="" class="m-2" method="POST" enctype="multipart/form-data">
                            <div class="my-1">
                                <label for="formFile" class="form-label">Upload <?= $label; ?> file Excel (XLS, XLSX) ke
                                    database</label>
                                <div>
                                    ...
                                    <a href="download/<?= $file_download; ?>" class="text-decoration-none" download>&nbsp;
                                        <svg style="color: rgb(23, 135, 8);" width="15" height="15" viewBox="0 0 15 15"
                                    ...
                                    <div class="alert alert-warning p-1 mb-2 w-75 mx-auto">
                                        ...
                                        <li>Isi data kolom yang kosong dengan "0" (untuk bilangan/jumlah) atau "-" (untuk
                                            keterangan/nama).</li>
                                    </div>
                                </div>
                            ...
                            <button type="submit" name="upload" value="<?= ($i + 1); ?>"
